...
public class Register_Steps {
	...
	public void read_valid_data_from_excel(Integer rowNumber) {
		...
		try {
			if (testdata == null) {
				testdata = reader.getData(AppConstants.TEST_DATA_EXCEL_PATH,
						AppConstants.REGISTER_VALID_USER_TEST_SHEET);
			}
	...
	public void read_invalid_data_from_excel(Integer rowNumber) {
		...
		try {
			if (testdata == null) {
				testdata = reader.getData(AppConstants.TEST_DATA_EXCEL_PATH,
						AppConstants.REGISTER_INVALID_USER_TEST_SHEET);
			}
			String username = testdata.get(rowNumber).get("username");
			String password = testdata.get(rowNumber).get("password");
			String passwordConfirmation = testdata.get(rowNumber).get("passwordConfirmation");
	...
	public void the_user_is_redirected_to_the_home_page() {
		...
		LoggerLoad.info("Assertion error in Register redirecting to home page: ");
	}
	...
	public void validate_success_message() {
		...
		LoggerLoad.info("Assertion error in Register validating success message: ");
	...
	public void validate_error_message() {
		...
		LoggerLoad.info("Assertion error in Register validating error message: ");
	...
	public void click_login() {
		try {
			...
			LoggerLoad.info("Assertion error in Register clicking login: ");
		}
	}
	...
	public void validate_user_in_login_page() {
		...
		LoggerLoad.info("Assertion error in Register validating redirecting to login page: ");
